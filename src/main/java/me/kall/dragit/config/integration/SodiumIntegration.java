...
public class SodiumIntegration {
    ...
    private static void addConfigPage(@NotNull OptionGUIConstructionEvent event) {
        OptionImpl<EmbeddiumOptions, Integer> chatWidth = OptionImpl.createBuilder(Integer.TYPE, sodiumOpts)
                .setId(Identifier.fromNamespaceAndPath(DragIt.MOD_ID, "chat_width"))
        ...
        OptionImpl<EmbeddiumOptions, Integer> chatHeight = OptionImpl.createBuilder(Integer.TYPE, sodiumOpts)
                .setId(Identifier.fromNamespaceAndPath(DragIt.MOD_ID, "chat_height"))
        ...
        OptionImpl<EmbeddiumOptions, Integer> chatPixels = OptionImpl.createBuilder(Integer.TYPE, sodiumOpts)
                .setId(Identifier.fromNamespaceAndPath(DragIt.MOD_ID, "chat_pixels"))
        ...
        OptionGroup chatGroup = OptionGroup.createBuilder().setId(Identifier.fromNamespaceAndPath(DragIt.MOD_ID, "chat_group")).add(chatWidth).add(chatHeight).add(chatPixels).build();

        OptionImpl<EmbeddiumOptions, Integer> paintingPixels = OptionImpl.createBuilder(Integer.TYPE, sodiumOpts)
                .setId(Identifier.fromNamespaceAndPath(DragIt.MOD_ID, "painting_pixels"))
        ...
        OptionGroup paintingGroup = OptionGroup.createBuilder().setId(Identifier.fromNamespaceAndPath(DragIt.MOD_ID, "painting_group")).add(paintingPixels).build();

        OptionImpl<EmbeddiumOptions, Integer> itemFramePixels = OptionImpl.createBuilder(Integer.TYPE, sodiumOpts)
                .setId(Identifier.fromNamespaceAndPath(DragIt.MOD_ID, "item_frame_pixels"))
        ...
        OptionGroup itemFrameGroup = OptionGroup.createBuilder().setId(Identifier.fromNamespaceAndPath(DragIt.MOD_ID, "item_frame_group")).add(itemFramePixels).build();

        OptionImpl<EmbeddiumOptions, Integer> capePixels = OptionImpl.createBuilder(Integer.TYPE, sodiumOpts)
                .setId(Identifier.fromNamespaceAndPath(DragIt.MOD_ID, "cape_pixels"))
        ...
        OptionGroup capeGroup = OptionGroup.createBuilder().setId(Identifier.fromNamespaceAndPath(DragIt.MOD_ID, "cape_group")).add(capePixels).build();
