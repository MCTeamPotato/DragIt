# DragIt
Drag and drop images into Minecraft to customize paintings and player skins.
## Features
...
- **Important**: Image and skin data is transmitted to the server and distributed to all players' clients. Be mindful of bandwidth - avoid uploading very large images
- Please respect copyright when using custom images